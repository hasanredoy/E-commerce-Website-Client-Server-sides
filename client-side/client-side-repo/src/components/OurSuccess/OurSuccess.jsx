...
const OurSuccess = () => {
  ...
  return (
    <section className="p-4 mb-5 md:p-8  ">
      <div>
        <Heading description={'Have a look at '} title={'Our Success'}></Heading>
      </div>
      <div className="container grid grid-cols-1 gap-10 m-4 mx-auto md:m-0 lg:grid-cols-3">
        {/* user stat  */}
        <div  data-aos="zoom-in" data-aos-delay="50"
    data-aos-duration="1000"
    data-aos-easing="ease-in-out" className="bg-[#01d6af] h-32 text-white flex overflow-hidden rounded-lg    flex-col p-5 ">
        ...
        <div data-aos="zoom-in" data-aos-delay="50"
    data-aos-duration="1000"
    data-aos-easing="ease-in-out" className="bg-[#01a98a] h-32 text-white flex overflow-hidden rounded-lg    flex-col p-5 ">
          <div className="flex items-center justify-center px-4  ">
            <svg
              fill="none"
              stroke="currentColor"
        ...
        <div data-aos="zoom-in" data-aos-delay="50"
    data-aos-duration="1000"
    data-aos-easing="ease-in-out" className="bg-[#01886f] h-32 text-white flex overflow-hidden rounded-lg    flex-col p-5 ">
          <div className="flex items-center justify-center px-4  ">
