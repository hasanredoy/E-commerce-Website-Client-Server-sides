  ...
  return (
    <div>
      <div>
        ...
        <h1 className=" my-5 text-4xl text-center font-bold">
      ...
      <div className="text-black overflow-x-auto mx-auto my-10 rounded-md bg-gray-300">
        ...
        <table className="table">
          ...
          <thead className=" text-white  bg-[#039396]">
            <tr>
              <th></th>
              <th className=" text-base lg:text-xl font-bold">Image</th>
              <th className=" text-base lg:text-xl font-bold">Item Name</th>
              <th className=" text-base lg:text-xl font-bold">Price</th>
              <th className=" text-base lg:text-xl font-bold">Details</th>
              <th className=" text-base lg:text-xl font-bold">Action</th>
            </tr>
          </thead>
          <tbody>
            {data?.map((item, index) => (
