...
const Navbar = () => {
  ...
  return (
    <div className="navbar bg-base-200  rounded-lg container mx-auto">
      <div className="navbar-start ">
        ...
        <Link to={"/"}>
          <div className=" ">
            <img
              src="https://i.postimg.cc/1z9Tgwjt/logo-my-Shop-removebg-preview.png"
      ...
      <div className="navbar-end flex gap-5">
        <div>
          <label className="swap swap-rotate">
            ...
            {/* moon icon */}
            <svg
            // onChange={()=>setToggle('dark')}
            // onClick={()=>handleLight('dark')}
      ...
      {user && (
        ...
        {user ? (
          <Link
            ...
            className="btn btn-outline btn-primary rounded-full text-white"
          >
            Logout
          </Link>
        ) : (
